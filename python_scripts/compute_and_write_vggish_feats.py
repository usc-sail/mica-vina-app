...
#def main(vggish_postprocess):
def compute_vggish_embeddings(script_dir, wav_file, pca_params, checkpoint, write_dir):
...
if __name__ == '__main__':
    ...
    compute_vggish_embeddings(wav_file, pca_params, checkpoint, write_dir)
#    tf.app.run(main=main, argv=[vggish_postprocess])
